  ...
  <div class="container mt-4 mb-4">
    ...
    <div class="hentai mt-4 mb-4">
      <div class="list-hentai">
        <div class="row mt-2">
          <?php
            $html = str_get_html(file_get_contents("https://hentaimama.io/series/?page=".$step."&status=&type=&order=update"));
              ...
              foreach($bsx->find("a") as $hrf){
                foreach($bsx->find("img") as $gbr){
                  ...
                  <div class="card ml-4 mt-4 bg-dark" style="width: 142px;">
                    <a href="info.php?id=<?php $cet=str_replace("https://hentaimama.io/", "", $hrf->href); echo $cet; ?>">
    ...
    <ul class="pagination justify-content-center">
      <?php
        foreach ($html->find("div[class=hpage]") as $got){
          foreach($got->find("a[class=l]") as $gut){
            $goy = str_replace(array("?page=","&status=&type=&order=update"), array("",""), $gut->href);
            ?>
              <li class="page-item"><a href="next.php?page=<?= $goy; ?>" class="page-link">Previous</a></li>
            <?php
          }
          foreach($got->find("a[class=r]") as $gud){
            $god = str_replace(array("?page=","&status=&type=&order=update"), array("",""), $gud->href);
            ?>
              <li class="page-item"><a href="next.php?page=<?= $god; ?>" class="page-link">Next</a></li>
            <?php
          }
        }
      ?>
