<?php
  ...
  $ht = str_get_html(file_get_contents("https://hentaimama.io/".$_GET["id"]));
    ...
    <div class="eg">
      ...
      foreach($ht->find("div[class=eplister]") as $val){
	      foreach($val->find("a") as $li){
		      ...
		      ?>
          <a href="nonton.php?name=<?php $cut = str_replace("https://hentaimama.io/", "", $li->href); echo $cut; ?>"><h6><span class="text-left"><?= $a; ?>.</span> <span class="text-center"><?= $b; ?></span></h6></a><br>
		      <?php
	      }
      }
      ?>
