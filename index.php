  ...
  <div class="container mt-4 mb-4">
    ...
    <div class="hentai mt-4 mb-4">
      <div class="list-hentai">
        <div class="row mt-2">
          <?php
          $html = str_get_html(file_get_contents("https://hentaimama.io/series/?status=&type=&order=update"));
              ...
              foreach($gm->find("img") as $gmb){
                ?>
                  <div class="card ml-4 mt-4 bg-dark" style="width: 142px;">
                    <a href="hentai/info.php?id=<?php $cet=str_replace("https://hentaimama.io/", "", $ling->href); echo $cet; ?>">
